        ...
        <table className="table table-bordered text-center">
          <thead className="table-light">
            <tr>
              ...
              <th className="fw-medium text-center align-middle">Size chart</th>
              <th className="fw-medium text-center align-middle">Video</th>
              <th className="fw-medium text-center align-middle">Cầu hình mặc định</th>
