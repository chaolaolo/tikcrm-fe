        ...
        <div className="w-100" style={{ maxWidth: '600px', }}>
          ...
          <div className="card p-8 " style={{
            ...
            <form>
              ...
              <div className="mb-3 text-start">
                <label htmlFor="referralCode" className="col-sm-2 col-form-label col-form-label-sm text-secondary">Referral code</label>
                <input
                  type="text"
                  className="form-control"
                  id="referralCode"
              ...
              <div className="text-center">
                ...
                <Link to="/login"
                  className="custom-hover-underline form-control  fw-normal" style={{ fontSize: '16px', color: '#47bac1' }}>
                  Sign In
                </Link>
