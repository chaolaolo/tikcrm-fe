            ...
            <form>
              ...
              <div className="mb-3 text-start">
                <Link to="/forgot-password"
                  className="text-decoration-none text-black fw-normal" style={{ fontSize: '16px', color: '#47bac1' }}>
                  Forgot password
                </Link>
              ...
              <div className="text-center">
                ...
                <Link to="/register"
                  className="text-decoration-none  fw-normal" style={{ fontSize: '16px' , color: '#47bac1'}}>
                  Sign Up
                </Link>
