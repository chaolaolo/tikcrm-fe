...
const fulfillments = [
  {
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Example_image.svg/600px-Example_image.svg.png'
  },
  {
    name: 'PRINTWAY',
...
const FulfillManagementPage: React.FC = () => {
  return (
            ...
            >
              <div className="d-flex align-items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mb-0 text-muted small" style={{ maxWidth: '600px' }}>{item.description}</p>
                </div>
              </div>
...
export default FulfillManagementPage;
