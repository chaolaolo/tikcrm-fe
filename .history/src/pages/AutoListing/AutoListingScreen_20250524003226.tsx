  ...
  return (
    <div className="container-fluid bg-light min-vh-100 p-4">
      <div className="bg-white rounded shadow-sm p-4">
        <h5 className="mb-4">Schedule Products</h5>

        {/* Tabs */}
        <ul className="nav nav-tabs mb-4">
          <li className="nav-item">
            <a className="nav-link active" href="#">Publish Product</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#">Draft</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#">Scheduled List</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#">Product Publishing Progress</a>
          </li>
        </ul>
