...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      {/* Sidebar */}
      <div 
        className={`text-white position-fixed h-100 ${isCollapsed ? 'collapsed-sidebar' : ''}`}
        style={{ 
      ...
      >
        ...
        <div className="py-3">
          ...
          <div className="px-3 mb-2">
            {!isCollapsed && <small className="text-white-50 text-uppercase fw-bold">Products</small>}
          </div>
          
          <div className="px-2">
            <a href="#" className="d-flex align-items-center text-white-50 text-decoration-none p-2 rounded mb-1 bg-primary">
