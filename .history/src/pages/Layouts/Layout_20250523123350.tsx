...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      {/* Sidebar */}
      <div 
        className={`bg-dark text-white position-fixed h-100 ${isCollapsed ? 'collapsed-sidebar' : ''}`}
        style={{ 
      ...
      >
        ...
        <div className="py-3">
          ...
          <div className="px-3 mb-2">
            {/* {!isCollapsed && <small className="text-muted text-uppercase fw-bold">Products</small>} */}
            <p className="text-muted text-uppercase text-white fw-bold">Products</p>
          </div>
          
          <div className="px-2">
            <a href="#" className="d-flex align-items-center text-primary text-decoration-none p-2 rounded mb-1 bg-primary">
              <i className="bi bi-box me-3" style={{ width: '20px' }}></i>
              {!isCollapsed && <span>Order Management</span>}
            </a>
            <a href="#" className="d-flex align-items-center text-white text-decoration-none p-2 rounded mb-1 hover-bg-secondary">
          ...
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-muted text-uppercase fw-bold">Tools</small>}
          </div>
          ...
          {/* Fulfill Section */}
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-muted text-uppercase fw-bold">Fulfill</small>}
          </div>
          ...
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-muted text-uppercase fw-bold">Quản lý tài chính</small>}
          </div>
          ...
          {/* Accounts Section */}
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-muted text-uppercase fw-bold">Accounts</small>}
          </div>
