      ...
      >
        ...
        <div className="py-3">
          ...
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-white-50 text-uppercase fw-bold">Tools</small>}
          </div>
          ...
          {/* Fulfill Section */}
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-white-50 text-uppercase fw-bold">Fulfill</small>}
          </div>
          ...
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-white-50 text-uppercase fw-bold">Quản lý tài chính</small>}
          </div>
          ...
          {/* Accounts Section */}
          <div className="px-3 mb-2 mt-4">
            {!isCollapsed && <small className="text-white-50 text-uppercase fw-bold">Accounts</small>}
          </div>
          ...
          <div className="px-2">
            ...
            <a href="#" className="d-flex align-items-center text-secondary-emphasis text-decoration-none p-2 rounded mb-1 hover-bg-secondary">
