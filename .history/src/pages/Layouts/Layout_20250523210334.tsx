...
const OrderManagementScreen = ({ onTabClick }: { onTabClick: (tab: string) => void }) => (
    <div>
            ...
            <div className="col-md-12">
                ...
                <ul className="nav nav-tabs mb-3">
                    <li className="nav-item">
                        <a className="nav-link active" href="#" onClick={(e) => { e.preventDefault(); onTabClick('orders-without-design'); }}>Orders Without Design</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" onClick={(e) => { e.preventDefault(); onTabClick('orders-with-design'); }}>Orders With Design (Not Yet Fulfilled)</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" onClick={(e) => { e.preventDefault(); onTabClick('overdue-orders'); }}>Overdue Orders</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" onClick={(e) => { e.preventDefault(); onTabClick('suspicious-orders'); }}>Suspicious Orders</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" onClick={(e) => { e.preventDefault(); onTabClick('returned-orders'); }}>Returned Orders</a>
                    </li>
                </ul>
...
const ProductManagementScreen = ({ onTabClick }: { onTabClick: (tab: string) => void }) => (
    <div>
    ...
    const renderContent = () => {
        ...
        switch (activeScreen) {
            case 'order-management':
                return <OrderManagementScreen onTabClick={handleMenuClick}/>;
