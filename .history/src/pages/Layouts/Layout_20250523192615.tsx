...
const ProductManagementScreen = ({ onTabClick }) => (
  <div>
  ...
  const renderContent = () => {
    ...
    switch (activeScreen) {
      ...
      case 'product-management':
        return <ProductManagementScreen onTabClick={handleMenuClick} />;
        ...
        <div className="py-3 flex-grow-1">
          ...
          <div className="ms-4">
            <a 
              ...
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'order-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'product-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'niche-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
          ...
          <div className="ms-4">
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'auto-listing' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'promotions' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'task-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
          ...
          <div className="ms-4">
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'fulfill-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
          ...
          <div className="ms-4">
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'bank-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
          ...
          <div className="ms-4">
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'payment-center' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'connect-shop' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'staff-management' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'account-settings' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
            ...
            <a 
              href="#" 
              className={`d-flex align-items-center text-decoration-none p-2 rounded mb-1 ${
                activeScreen === 'template-settings' ? 'text-white bg-primary' : 'text-white-50 hover-bg-secondary'
              }`}
